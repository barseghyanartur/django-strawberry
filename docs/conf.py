# -*- coding: utf-8 -*-
#
# django-strawberry documentation build configuration file, created
...
try:
    ...
    version = '0.1'
    project = u'django-strawberry'
    copyright = u'2018, Artur Barseghyan <artur.barseghyan@gmail.com>'
...
htmlhelp_basename = 'django-strawberrydoc'
...
latex_documents = [
  ('index',
   'django-strawberry.tex',
   u'django-strawberry Documentation',
